package com.kc3c2016.myivc.util;
...
public class NetworkSingleton {
    ...
    public static final String ACTION_BLUETOOTH_OPENED = "com.kc3c2016.myivc.ACTION_BLUETOOTH_OPENED";
    public static final String ACTION_BLUETOOTH_CAR_CONNECTED = "com.kc3c2016.myivc.ACTION_BLUETOOTH_CAR_CONNECTED";
    public static final String ACTION_BLUETOOTH_ERROR = "com.kc3c2016.myivc.ACTION_BLUETOOTH_ERROR";
    public static final String ACTION_WIFI_ENABLE = "com.kc3c2016.myivc.ACTION_WIFI_ENABLE";
    public static final String ACTION_WIFI_CLOSED = "com.kc3c2016.myivc.ACTION_WIFI_CLOSED";
    public static final String ACTION_WIFI_LISTENER_THREAD_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_LISTENER_THREAD_CREATED";
    public static final String ACTION_WIFI_CONTROL_SENDER_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_CONTROL_SENDER_CREATED";
    public static final String ACTION_WIFI_VIDEO_SENDER_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_VIDEO_SENDER_CREATED";
    public static final String ACTION_WIFI_CONTROL_SENDER_THREAD_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_CONTROL_SENDER_THREAD_CREATED";
    public static final String ACTION_WIFI_VIDEO_SENDER_THREAD_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_VIDEO_SENDER_THREAD_CREATED";
    public static final String ACTION_WIFI_CONTROL_LISTNER_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_CONTROL_LISTNER_CREATED";
    public static final String ACTION_WIFI_VIDEO_LISTNER_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_VIDEO_LISTNER_CREATED";
    public static final String ACTION_WIFI_UDP_LISTNER_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_UDP_LISTNER_CREATED";
    public static final String ACTION_WIFI_UDP_SENDER_CREATED = "com.kc3c2016.myivc.ACTION_WIFI_UDP_SENDER_CREATED";
    public static final String ACTION_WIFI_READ_CONTROL_THREAD_CLOSED = "com.kc3c2016.myivc.ACTION_WIFI_READ_CONTROL_THREAD_CLOSED";
    public static final String ACTION_WIFI_READ_VIDEO_THREAD_CLOSED = "com.kc3c2016.myivc.ACTION_WIFI_READ_VIDEO_THREAD_CLOSED";
    public static final String ACTION_ONRECEIVE_CONTROL_MSG = "com.kc3c2016.myivc.ACTION_ONRECEIVE_CONTROL_MSG";
    public static final String ACTION_ONRECEIVE_VIDEO_BEGIN = "com.kc3c2016.myivc.ACTION_ONRECEIVE_VIDEO_BEGIN";
    public static final String ACTION_ONRECEIVE_VIDEO_STOP = "com.kc3c2016.myivc.ACTION_ONRECEIVE_VIDEO_STOP";
        ...
        SendControlThreadQueue = new Thread() {
            ...
            public void run() {
                ...
                while (!isInterrupted()) {
                    ...
                    Log.e("sendControlSocket", "HERE");
                    if (sendControlSocket==null || sendControlSocket.isClosed()) {
                        Log.e("sendControlSocket", "NULL");
                        continue;
                    }
                    try {
                        Log.e("sendControlSocket","Sending");
                        sendControlSocket.getOutputStream().write(ControlMessageQueue[0]);
                        sendControlSocket.getOutputStream().flush();
                        Log.e("sendControlSocket","Sent");
                    } catch (Exception e) {
